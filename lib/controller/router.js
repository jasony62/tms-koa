...
async function fnCtrlWrapper(ctx, next) {
  ...
  let access_white
  if (Object.prototype.hasOwnProperty.call(CtrlClass, 'get_access_white')) access_white = CtrlClass.get_access_white()

  if (access_white && access_white.includes(method)) {
    // 跳过鉴权
