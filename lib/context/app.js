  ...
  if (authConfig.mode) {
    if (client && typeof client === 'object') {
      ...
      if (typeof npm === 'object' && npm.disabled !== true) {
        ...
        } else { // 如果没有指定module 那么 authentication、register 指定的应该是一个独立的模块文件
          if (authentication && typeof authentication === 'string') {
        ...
        authConfig.client = { createTmsClient, registerTmsClient }
    ...
    if (captcha && typeof captcha === 'object') {
      ...
      if (typeof npm === 'object' && npm.disabled !== true) {
        ...
        } else { // 如果没有指定module 那么 generator、checker 指定的应该是一个独立的模块文件
          if (generator && typeof generator === 'string') {
