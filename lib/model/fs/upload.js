...
class UploadPlain extends Upload {
   ...
   *
   */
  async storeByUrl(fileUrl, dir, forceReplace = 'N', fileName = '', axiosInstance = null) {
    const axios = require("axios")

    if (Object.prototype.toString.call(axiosInstance) !== '[object Function]' || typeof axiosInstance.request === 'function') {
    ...
    return axiosInstance.request()
      ...
      .then(async file => {
        ...
        let filepath = await this.fs.write(fileName, file.data, true, { encoding: 'binary' })
