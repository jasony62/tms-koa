...
function getPool(path) {
    ...
    console.log(`新建默认数据库（master）连接池`)
 ...
 * @param {DbContext} options.context
 * @param {boolean} options.debug 
 */
function create({ context = null, debug = false } = {}) {
    let db = new Db({ context, debug })
    return db
}

module.exports = { Db, DbContext, create }